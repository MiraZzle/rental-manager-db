...
create index ix_requests_date on requests(request_date);

-- bitmap status indexy
create bitmap index ix_payments_status on payments(status);
create bitmap index ix_requests_status on requests(status);
